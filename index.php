            ...
            <section class="hero" id="home">
                ...
                <div class="container">
                    <div class="row palm-view-hero ">
                        <div class="col-md-5 col-lg-5 " data-aos="fade-up" data-aos-duration="2000" data-aos-delay="700"
                            data-aos-anchor-placement="center-bottom">
                            <h1> Tired of forgetting schedules?</h1>
                            <p class="mt-3">Say Goodbye to attention difficulty, limited attention and <br>
                                impulsiveness. An app made specially for you. <br> Be the first to know when we launch
                            </p>
                            <div>
                        ...
                        <section class="phone">
                            <div>
                                <div class="col-md-6 phone col-lg-6" data-aos="fade-left" data-aos-duration="2000"
                    ...
                    <main>
                        <div class="row">
                            ...
                            <div class="images__content col-md-4 col-lg-4">
                                <aside>
                                    <div class=" ">
                                        <img id='img' class="fixe" src="./Assets/general/Hero Image (3).png" alt="">
                                    </div>
                ...
                <div class="container">
                    ...
                    <div class="app__features">
                        <div class="caption pt-5">
                            ...
                            <div class="p">
                                <p>Fermentum duis egestas non natoque gravida faucibus leo tempor egestas. Eu leo lectus
                                    ligula nec malesuada id leo proin pretium. Justo vulputate nunc, ut dictum in
                                    bibendum <br> volutpat massa rutrum.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-5 ">
                        <div class="col-md-6 col-lg-6">
                            <div class="row">
                                <div class="col-2 count" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000">
                                    <h5 class="pt-1">01</h5>
                                </div>
                                <div class="col-8 why__use__header">
                                    <p class="why__header">See how customers connect</p>
                                    <p class="why__description"> Clicks, calls, bookings, follows – see how your
                                        customers engage with your Business Profile.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="row">
                                <div class="col-2 count" data-aos="flip-right" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000" >
                                    <h5 class="pt-1">02</h5>
                                </div>
                                <div class="col-8 why__use__header">
                        ...
                        <div class="col-md-6 col-lg-6 f">
                            <form class="needs-validation" method="POST" action="./process.php">
                                <div class="input-group mt-4">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-outline" onclick='change()' value="submit"
