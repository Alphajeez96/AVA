...
<body>
                    ...
                    <div>
                        <form id='form' method="POST" action="./process.php">
                            <div class="input-group mt-4">
                                <input type="email" class="form-control" id='email' placeholder="Enter email address" required aria-describedby="basic-addon2" name='email'>
    ...
    <!-- APP FEATURES WITH SCROLL EFFECT HERE -->
    ...
    <section class="app__screens">
        <div class="container">
            ...
            <div class="rows increase">
                <div class="col-md-5 col-lg-5 headers" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="700" data-aos-anchor-placement="center-bottom">
            ...
            <div class="rows column__reverse">
                <div class="col-md-5 col-lg-5  headers" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="1000" data-aos-anchor-placement="center-bottom">
            ...
            <div class="rows column__reverse">
                <div class="col-md-5 col-lg-5 headers" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="1200" data-aos-anchor-placement="center-bottom">
                ...
                <div class="col-md-6 col-lg-6 f">
                    <form id='form' method="POST" action="./process.php">
                        <div class="input-group mt-4">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline" id='register' value="submit" type="submit">NOTIFY
                                    ME</button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="container">
                    <div class="row foot__row">
                        ...
                        <div class="col-md-6 footer__credit">
                            <p> Designed by <span><a href='https://dribbble.com/ojotule'>@Anibe</a> </span>, Coded by
                                <span><a href="https://github.com/Alphajeez96">@Alphajeez</a> </span> </p>
                        </div>
                    </div>
                </div>
            </footer>
